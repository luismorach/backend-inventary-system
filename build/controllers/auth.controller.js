...
const usuariosController_1 = __importDefault(require("./usuariosController"));
...
class AuthController {
    ...
    async changePassword(req, res) {
        ...
        try {
            ...
            await conection_1.default.query('UPDATE users SET password_user=$1 WHERE id_user=$2', [newPassword, payload.id_user]);
            res.json({
