...
exports.sendEmail = exports.getOptionsEmail = exports.getTransportEmail = void 0;
const nodemailer = require('nodemailer');
function getTransportEmail(building) {
...
exports.getTransportEmail = getTransportEmail;
function getOptionsEmail(building, user, verificationLink) {
    return {
        from: building.email,
        subject: 'Autogestión',
        to: user.email_user,
...
exports.getOptionsEmail = getOptionsEmail;
function getTemplateEmail(building, user, verificationLink) {
    let html = `
             <!DOCTYPE html>
             <html lang="en">
             <head>
...
async function sendEmail(transport, options, res) {
    try {
