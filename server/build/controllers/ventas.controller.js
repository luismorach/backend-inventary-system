...
class VentasController {
    ...
    async getVentaById(req, res) {
        ...
        const response = await database_1.default.query('SELECT distinct on (sells.id_sell)* FROM sells JOIN users ON ' +
    ...
    async getVentasByDate(req, res) {
        ...
        const response = await database_1.default.query('SELECT distinct on (sells.id_sell)* FROM sells ' +
    ...
    async getVentaByDate(req, res) {
        const initialDate = req.params.initialDate;
        const endDate = req.params.endDate;
        const response = await database_1.default.query('SELECT registers.name_register,users.names_user,users.last_names_user, ' +
    ...
    async getPagosVentaById(req, res) {
        const id_sell = parseInt(req.params.id_sell);
        const response = await database_1.default.query('SELECT distinct on (pays.id_pay)* FROM pays JOIN users ON ' +
    ...
    async getPagosVentaByDate(req, res) {
        const initialDate = req.params.initialDate;
        const endDate = req.params.endDate;
        const response = await database_1.default.query("SELECT currency,c.currency_code,c.language_code,c.country_code, " +
