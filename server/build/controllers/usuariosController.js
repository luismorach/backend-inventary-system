...
class UsuariosController {
    async getUsuarios(req, res) {
        ...
        const response = await database_1.default.query('SELECT * FROM users WHERE id_user!=0 ORDER BY names_user ASC');
    ...
    async getUsuarioByDocument(document_type_user, document_number_user) {
        const response = await database_1.default.query('SELECT * FROM users u JOIN registers r ON ' +
    ...
    async actualizarUsuario(req, res) {
        ...
        await database_1.default.query('UPDATE users SET range_user=$1,id_register=$2,state_user=$3 ' +
